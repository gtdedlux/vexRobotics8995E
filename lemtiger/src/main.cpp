...
pros::MotorGroup left_mg({-4, -11, -10},pros::MotorGearset::blue);   
...
lemlib::TrackingWheel horizontal_tracking_wheel(&horizontal_encoder, lemlib::Omniwheel::NEW_2, -5.75); //change offsets 
// vertical tracking wheel
lemlib::TrackingWheel vertical_tracking_wheel(&vertical_encoder, lemlib::Omniwheel::NEW_2, -2.5); //offsets are relative to tracking center
// odometry settings
