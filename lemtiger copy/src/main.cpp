                    ...
                    pros::Task screen_task([&]() {
                        while (true) {
                           ...
                           // pros::lcd::print(0, "X: %f", chassis.getPose().x); // x
                            ...
                            //pros::lcd::print(7, "Sensor Pos: %d", armSensor.get_position());
...
void opcontrol() {
    ...
    while (true) {
        ...
        // **Toggle red and blue sorting**
        if (master.get_digital_new_press(DIGITAL_RIGHT)) {
            redSortEnabled = !redSortEnabled;
            if (redSortEnabled){
                master.print(0, 0, "RedSort Enabled");
            }
            else{
                master.clear_line(0);
            }
        ...
        if (master.get_digital_new_press(DIGITAL_LEFT)) {
            ...
            if (blueSortEnabled){
                master.print(1, 0, "BlueSort Enabled");
            }
            else{
                master.clear_line(1);
            }
        ...
        // // **Intake control using L1 and L2**
        // if(distance.get_distance() < 60){
        //     if ((blueSortEnabled && optical.get_hue() >= 5 && optical.get_hue() <= 25) || (redSortEnabled && optical.get_hue() >= 200 && optical.get_hue() <= 210)) {
        //         intake11W.move_relative(200, 600);  // Reverse intake momentarily
        ...
        // }
// if (!sorting) {
//     if (distance.get_distance() < 15) {  
//         setIntake(100);  // Slow intake slightly when detecting an object
//         pros::delay(100);  // Give sensor time to stabilize
//     } else {
